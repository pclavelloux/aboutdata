                    ...
                    <div className="grid grid-cols-8 gap-10">
                        ...
                        <div className='text-center col-span-4'>
                            ...
                            <p>1. Use the search bar to find a resource. <br />2. Click on the resource you want to promote <br />
                                ...
                                4. Choose a quantity <span className='text-sm'>(i.e the number of months to stay promoted. <br /> Ex: A quantity of 3 means the resource will be promoted for 3 months.)</span>
